...
<!-- <link rel="stylesheet" href="CSS/Python_Employee_Search.css"> -->
...
<nav class="mb-3 shadow">
 ...
 <%
    ...
    try {
        ...
        pstmt = con.prepareStatement(QueryUtil.Python_Employee_Search_selectQuery);
...
%>
  ...
  <td>
    ...
    <a href='Python_EmployeeSearch_Download_Servlet?id=<%= rs.getString("id") %>' class="download-link">Download</a>
   </button>
 </td>
            </tr>
<%
