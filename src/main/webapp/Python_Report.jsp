...
<!-- <link rel="stylesheet" href="CSS/Python_Report.css"> -->
...
<body>
	...
	<!-- 	<div class="containers">
		<form action="python_search_batch_id_download" method="get">
			<label for="batchId">Search Batch ID</label> <input type="text"
				id="batchId" name="batchId" required>
			<button type="submit">Search and Download</button>
		</form>

		<form action="LanguageSearchServlet" method="get">
			<label for="language">Search Language</label> <input type="text"
				id="language" name="language" required>
			<button type="submit">Search</button>
		</form>

		<form action="Python_Employee_Search.jsp" method="get">
			<label for="searchEmpNo">Search Employee ID</label> <input
				type="text" id="id" name="id" required>
			<button type="submit">Search</button>
		</form>

		<form action="Python_Show_All_Batches.jsp" method="post">
