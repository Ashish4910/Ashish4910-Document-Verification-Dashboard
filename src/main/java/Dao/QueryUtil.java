...
public class QueryUtil {
	...
	public static final String LoginServlet_SELECT_USER_ACCESS_QUERY = "SELECT * FROM user_access WHERE ntid=? AND user_accesscol=1";
	...
	public static final String Authorization_Servlet_Insert_USER_QUERY = "INSERT INTO [user] (ntid, password, job_title) VALUES (?, ?, ?)";
	public static final String Authorization_Servlet_Insert_USERACCESS_QUERY = "INSERT INTO user_access (ntid, password, job_title, user_accesscol) VALUES (?, ?, ?, 0)";
	...
	public static final String GrantRecordServlet_Insert_user_access = "INSERT INTO user_access (id, ntid, password, job_title, user_accesscol)"
			+ "SELECT id, ntid, password, job_title, 1 FROM ems.user WHERE id = ?";
