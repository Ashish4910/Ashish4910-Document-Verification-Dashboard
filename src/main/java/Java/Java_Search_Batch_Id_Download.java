...
public class Java_Search_Batch_Id_Download extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (OutputStream outputStream = response.getOutputStream()) {
            ...
            try {
                ...
                PreparedStatement selectStmt = sourceConn.prepareStatement(QueryUtil.Java_Search_Batch_Id_Download_selectQuery);
                selectStmt.setString(1, batchId);

                ResultSet rs = selectStmt.executeQuery();

                boolean batchIdExists = Method_Util.java_checkIfBatchIdExists(sourceConn, QueryUtil.Java_Search_Batch_Id_Download_selectQuery, batchId);
                ...
                if (!batchIdExists) {
                	...
                	response.sendRedirect("Java_Batch_error.jsp?errorMessage=" + errorMessage);
